...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 Movie Updates 🤖', url='https://telegram.me/darkmarsel8')
            ],
            [
                InlineKeyboardButton('⚡ Movie Channel ⚡', url=f"https://telegram.me/darkmarsel"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/darkmarsel8"),
            InlineKeyboardButton('🎥 movie Channel 🎥', url='https://t.me/darkmarsel')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/darkmarsel')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
